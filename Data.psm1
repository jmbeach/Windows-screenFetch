...
{
    return $env:USERNAME + "@" + (Get-OSInstance).CSName;
}
...
Function Get-RAM() 
{
    $FreeRam = ([math]::Truncate((Get-OSInstance).FreePhysicalMemory / 1KB)); 
